...
<div style="position : absolute; bottom : 0px; left : 0px; margin : 20px; padding : 5px; background-color:#ce3635;">
  <a href="https://khongan.com" style="color: white; text-decoration : none; font-family: 'Lato', sans-serif; text-shadow: 1px 1px 1px black;">Đói trong mưa...</a>
</div>
<img src="images/boy-love-propose-to-girl_152.png" style="
    position: absolute;
    bottom : 0px;
    left : 0px;
    margin : 20px;
...
function rendu(ctx) {
	...
	for (var i = 0, gouttesactives; gouttesactives = goutteslocales[i]; i++) {
      ...
      ctx.lineTo(mouse.X-138, mouse.Y+10);
			ctx.lineWidth = 3;
      ...
      ctx.stroke();
      ctx.beginPath();
			ctx.arc(mouse.X-10, mouse.Y+100, 10, 0 * Math.PI, -1 * Math.PI, false);
			ctx.lineWidth = 3;
			ctx.strokeStyle = "hsla(0,100%,100%,1)";
			ctx.stroke();
		}
